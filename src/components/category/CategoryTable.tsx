...
import CategoryBodyModalCreate from "./CategoryBodyModalCreate";
import CategoryBodyModalUpdate from "./CategoryBodyModalUpdate";
...
const CategoryTable: React.FC<ITable> = ({ title }) => {
  ...
  const handleThumbnail = (data: React.SetStateAction<File[]>) => {
    setImages(data);
  };
      ...
      <div className="flex flex-col">
        ...
        {commonState.isOpenModal && (
          <Modal
            ...
            body={
              isCreate ? (
                <CategoryBodyModalCreate
                  handleThumbnail={handleThumbnail}
                  closeModal={closeModal}
                  images={images}
                />
              ) : (
                <CategoryBodyModalUpdate
                  handleThumbnail={handleThumbnail}
                  closeModal={closeModal}
